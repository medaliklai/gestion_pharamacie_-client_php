		...
		<style >
			...
			.form-mod{
				...
				.form-mod input:hover{
					...
					box-shadow:2px 2px 2px 2px rgba(30,144,255,0.3);
...
<body>
	...
	?>
	<div style="position: absolute;top: 400px; left: 40%;"><h4 style="color: red;"><?php print('aucune pharmacie qui contient le médicament  '.$_POST['nom'] )?></h4></div>
<?php
}
}
?>
			...
			<form method="POST"  action="#" class="form-mod">
				<div class="row">
					<div class="col-md-6">
							...
							<input class="form-control" style="position: absolute;width: 200px;" type="text" name="nom"  placeholder="Nom de médicaments" required/>  <br/>
							<select name="type" class="form-control" style="position: absolute;top: 0px;left: 40%;width: 200px;" required>
								<option value="" disabled selected>type de pharmacie </option>
								<option>jour</option>
								<option>nuit</option>
							</select>
							<select name="ville" class="form-control"style="position: absolute;top: 0px;left: 80%;" required>
...
<?php
				...
				if ((isset($_POST['nom']) and (isset($_POST['type']) and(isset($_POST['ville']))))) {
					?>
				<div style="position: absolute;top: 350px; left: 50%;"><h4>resultat de recherche:<?php echo $nb ?></h4></div>
					<?php
			...
			<div class="col-md-4">
					...
					<div class="affiche" >
						...
						<a href="http://localhost/g_pharmacie/client/login_client.php" class="btn btn-warning">passer une commade</a>
